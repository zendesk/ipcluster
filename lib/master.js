...
function Master(options) {
	...
	// the code below is a *cough* unreliable way to convert when needed
	// it works under the assumption that no sane person using ipcluster would
	// set the thresholds to 1TB RAM or more.
	if (this.options.retire_rss   < ONE_MB) this.options.retire_rss   *= ONE_MB;
	if (this.options.totalmaxheap < ONE_MB) this.options.totalmaxheap *= ONE_MB;
